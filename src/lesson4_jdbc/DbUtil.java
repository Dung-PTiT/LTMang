...
public class DbUtil {
    ...
    public DbUtil() {
        ...
        strUser = "sa";
        strPass = "abc123";
        port = 1433; // SQL Server # 3306 1521
        strClassName = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
        strConnURL = "jdbc:sqlserver://"+ strHost +":"+port+";DatabaseName=" 
                        + strDbName + ";integratedSecurity=true";
    }
